...
For your convenience, the latest version of the script can be downloaded https://raw.githubusercontent.com/rseichter/fangfrisch/master/contrib/process-news.sh[here].
----
include::../contrib/process-news.sh[]
----
