...
Default: `default`, alternative: `disabled`.
In default mode, Fangfrisch will attempt to automatically delete obsolete virus definition files when you disable a provider section.
Please think carefully before disabling this option.
