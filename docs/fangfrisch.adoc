...
Details about the configuration parser and extended interpolation are avalable https://docs.python.org/3.7/library/configparser.html[here].
...
filename_spam = ${prefix}spam_spam_spam_wonderful_spam.db
----
