...
* *dumppaths*: Dump URL-to-filepath mappings to stdout.
For each active signature file URL in the given config file, a 3-tuple (section name, URL, effective file path) is printed.
