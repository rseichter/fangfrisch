...
If you come across bugs or have suggestions, you should file an issue on https://github.com/rseichter/fangfrisch[GitHub].
To avoid unnecessary effort, please always check existing issues first, including closed ones.
